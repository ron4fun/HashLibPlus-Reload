...
namespace CryptoHashTests
{
	TEST_CASE("Blake2BTests")
	{
		...
		//
		Blake2BConfig config = Blake2BConfig::CreateBlake2BConfig(64);
		...
		{
			Blake2BConfig ConfigNoKeyed, ConfigNullKeyed;
		...
		SECTION("TestBlake2BTreeHashingMode")
		{
			...
			// Left leaf
			Blake2BTreeConfig treeConfigh00 = Blake2BTreeConfig::CreateBlake2BTreeConfig();
			...
			// Right leaf
			Blake2BTreeConfig treeConfigh01 = Blake2BTreeConfig::CreateBlake2BTreeConfig();
			...
			// Root node
			Blake2BTreeConfig treeConfigh10 = Blake2BTreeConfig::CreateBlake2BTreeConfig();
