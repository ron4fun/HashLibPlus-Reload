...
{
	TEST_CASE("RIPEMD128Tests")
	{
		string HashOfEmptyData = "CDF26213A150DC3ECB610F18F6B38B46";
		string HashOfDefaultData = "75891B00B2874EDCAF7002CA98264193";
		string HashOfDefaultDataWithHMACWithLongKey = "DD8988DF3CEC7610583CBB179DF63436";
		string HashOfDefaultDataWithHMACWithShortKey = "BA844D13A1215E20634A49D5599197EF";
		string HashOfOnetoNine = "1886DB8ACDCBFEAB1E7EE3780400536F";
		string HashOfABCDE = "A0A954BE2A779BFB2129B72110C5782D";
			   
		IHash HashInstance = HashFactory::Crypto::CreateRIPEMD128();
