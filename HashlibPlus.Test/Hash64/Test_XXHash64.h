...
namespace Hash64Tests
{
	...
	{
		string HashOfEmptyData = "EF46DB3751D8E999";
		string HashOfDefaultData = "0F1FADEDD0B77861";
		string HashOfOnetoNine = "8CB841DB40E6AE83";
		string HashOfABCDE = "07E3670C0C8DC7EB";
		string HashOfDefaultDataWithEightByteKey = "68DCC1056096A94F";
