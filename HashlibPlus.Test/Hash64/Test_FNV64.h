...
{
	TEST_CASE("FNV_64Tests")
	{
		string HashOfEmptyData = "0000000000000000";
		string HashOfDefaultData = "061A6856F5925B83";
		string HashOfOnetoNine = "B8FB573C21FE68F1";
		string HashOfABCDE = "77018B280326F529";

		IHash HashInstance = HashFactory::Hash64::CreateFNV64();
