...
{
	TEST_CASE("Adler32Tests")
	{
		string HashOfEmptyData = "00000001";
		string HashOfDefaultData = "25D40524";
		string HashOfOnetoNine = "091E01DE";
		string HashOfABCDE = "05C801F0";
		
		IHash HashInstance = HashFactory::Checksum::CreateAdler32();
