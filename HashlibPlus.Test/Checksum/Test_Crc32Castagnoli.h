...
{
	TEST_CASE("Crc32CastagnoliTests")
	{
		string HashOfEmptyData = "00000000";
		string HashOfDefaultData = "22B17746";
		string HashOfOnetoNine = "E3069283";
		string HashOfABCDE = "C450D697";

		IHash HashInstance = IHash(HashFactory::Checksum::CreateCRC32_CASTAGNOLI());
