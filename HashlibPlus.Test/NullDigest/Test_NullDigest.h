...
namespace NullDigestTests
{
	TEST_CASE("NullDigestTests")
	{
		string HashOfEmptyData = "";
		string HashOfDefaultData = "486173684C69623450617363616C";
		string HashOfOnetoNine = "313233343536373839";
		string HashOfABCDE = "6162636465";

		IHash HashInstance = HashFactory::NullDigestFactory::CreateNullDigest();
