...
{
	TEST_CASE("XXHash32Tests")
	{
		string HashOfEmptyData = "02CC5D05";
		string HashOfDefaultData = "6A1C7A99";
		string HashOfOnetoNine = "937BAD67";
		string HashOfABCDE = "9738F19B";
		string HashOfDefaultDataWithFourByteKey = "728C6772";

		IHashWithKey HashInstance = HashFactory::Hash32::CreateXXHash32();
