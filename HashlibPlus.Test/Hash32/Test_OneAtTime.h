...
{
	TEST_CASE("OneAtTimeTests")
	{
		string HashOfEmptyData = "00000000";
		string HashOfDefaultData = "4E379A4F";
		string HashOfOnetoNine = "C66B58C5";
		string HashOfABCDE = "B98559FC";

		IHash HashInstance = HashFactory::Hash32::CreateOneAtTime();
