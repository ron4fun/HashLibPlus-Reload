...
{
	TEST_CASE("Bernstein1Tests")
	{
		string HashOfEmptyData = "00001505";
		string HashOfDefaultData = "2D122E48";
		string HashOfOnetoNine = "3BABEA14";
		string HashOfABCDE = "0A1DEB04";

		IHash HashInstance = HashFactory::Hash32::CreateBernstein1();
