...
namespace Hash32Tests
{
	TEST_CASE("JSTests")
	{
		string HashOfEmptyData = "4E67C6A7";
		string HashOfDefaultData = "683AFCFE";
		string HashOfOnetoNine = "90A4224B";
		string HashOfABCDE = "62E8C8B5";

		IHash HashInstance = HashFactory::Hash32::CreateJS();
