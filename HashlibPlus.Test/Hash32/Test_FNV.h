...
{
	TEST_CASE("FNV_32Tests")
	{
		string HashOfEmptyData = "00000000";
		string HashOfDefaultData = "BE611EA3";
		string HashOfOnetoNine = "D8D70BF1";
		string HashOfABCDE = "B2B39969";

		IHash HashInstance = HashFactory::Hash32::CreateFNV32();
