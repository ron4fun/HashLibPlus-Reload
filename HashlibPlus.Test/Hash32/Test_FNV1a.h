...
{
	TEST_CASE("FNV1a_32Tests")
	{
		string HashOfEmptyData = "811C9DC5";
		string HashOfDefaultData = "1892F1F8";
		string HashOfOnetoNine = "BB86B11C";
		string HashOfABCDE = "749BCF08";

		IHash HashInstance = HashFactory::Hash32::CreateFNV1a_32();
