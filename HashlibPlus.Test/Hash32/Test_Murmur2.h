...
{
	TEST_CASE("Murmur2_32Tests")
	{
		string HashOfEmptyData = "00000000";
		string HashOfDefaultData = "30512DE6";
		string HashOfOnetoNine = "DCCB0167";
		string HashOfABCDE = "5F09A8DE";
		string HashOfDefaultDataWithFourByteKey = "B15D52F0";

		IHashWithKey HashInstance = HashFactory::Hash32::CreateMurmur2_32();
