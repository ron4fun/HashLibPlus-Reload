...
{
	TEST_CASE("SuperFastTests")
	{
		string HashOfEmptyData = "00000000";
		string HashOfDefaultData = "F00EB3C0";
		string HashOfOnetoNine = "9575A2E9";
		string HashOfABCDE = "51ED072E";

		IHash HashInstance = HashFactory::Hash32::CreateSuperFast();
