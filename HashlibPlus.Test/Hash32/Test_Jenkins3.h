...
{
	TEST_CASE("Jenkins3Tests")
	{
		string HashOfEmptyData = "DEADBEEF";
		string HashOfDefaultData = "F0F69CEF";
		string HashOfOnetoNine = "845D9A96";
		string HashOfABCDE = "026D72DE";

		IHash HashInstance = HashFactory::Hash32::CreateJenkins3();
