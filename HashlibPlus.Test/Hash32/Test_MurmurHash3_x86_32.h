...
{
	TEST_CASE("MurmurHash3_x86_32Tests")
	{
		string HashOfEmptyData = "00000000";
		string HashOfDefaultData = "3D97B9EB";
		string HashOfOnetoNine = "B4FEF382";
		string HashOfABCDE = "E89B9AF6";
		string HashOfDefaultDataWithFourByteKey = "B05606FE";
		
		IHashWithKey HashInstance = HashFactory::Hash32::CreateMurmurHash3_x86_32();
