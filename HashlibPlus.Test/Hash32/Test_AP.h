...
namespace Hash32Tests
{
	TEST_CASE("APTests")
	{
		string HashOfEmptyData = "AAAAAAAA";
		string HashOfDefaultData = "7F14EFED";
		string HashOfOnetoNine = "C0E86BE5";
		string HashOfABCDE = "7F6A697A";

		IHash HashInstance = HashFactory::Hash32::CreateAP();
