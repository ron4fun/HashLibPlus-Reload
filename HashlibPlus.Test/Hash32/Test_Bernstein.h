...
{
	TEST_CASE("BernsteinTests")
	{
		string HashOfEmptyData = "00001505";
		string HashOfDefaultData = "C4635F48";
		string HashOfOnetoNine = "35CDBB82";
		string HashOfABCDE = "0F11B894";

		IHash HashInstance = HashFactory::Hash32::CreateBernstein();
