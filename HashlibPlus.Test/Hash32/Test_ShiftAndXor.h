...
{
	TEST_CASE("ShiftAndXorTests")
	{
		string HashOfEmptyData = "00000000";
		string HashOfDefaultData = "BD0A7DA4";
		string HashOfOnetoNine = "E164F745";
		string HashOfABCDE = "0731B823";

		IHash HashInstance = HashFactory::Hash32::CreateShiftAndXor();
