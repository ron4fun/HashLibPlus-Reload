...
{
	TEST_CASE("RotatingTests")
	{
		string HashOfEmptyData = "00000000";
		string HashOfDefaultData = "158009D3";
		string HashOfOnetoNine = "1076548B";
		string HashOfABCDE = "00674525";

		IHash HashInstance = HashFactory::Hash32::CreateRotating();
