...
class Bernstein1 : public Hash, public virtual IIHash32, public virtual IITransformBlock
{
public:
	Bernstein1()
		: Hash(4, 1)
	...
	{
		Bernstein1 HashInstance = Bernstein1();
		HashInstance._hash = _hash;
		HashInstance.SetBufferSize(GetBufferSize());

		return IHash(new Bernstein1(HashInstance));
	}
