...
class FNV1a_32 : public Hash, public virtual IIBlockHash, 
...
public:
	...
	{
		FNV1a_32 HashInstance = FNV1a_32();
		HashInstance._hash = _hash;
		HashInstance.SetBufferSize(GetBufferSize());

		return IHash(new FNV1a_32(HashInstance));
	}
